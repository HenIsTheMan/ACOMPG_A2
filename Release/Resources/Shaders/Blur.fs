...
void main(){ //Gaussian blur filter taking 5 tex samples in each dir (take more tex samples along a larger radius or blur more times [controlled in CPU] to improve) ++combine blur filters with blur kernels of diff sizes or use multiple Gaussian curves to selectively combine weights??
